    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button
          ...
          className="bg-blue-600 hover:bg-blue-500 border-none flex items-center gap-1.5 text-xs h-9 px-4 rounded-xl"
        >
          Create Repository
        </Button>
      </div>
                ...
                <div className="space-y-3">
                  ...
                  {repo.type === 'proxy' && repo.upstream_url && (
                    <div className="text-[11px] text-slate-400 bg-amber-950/20 border border-amber-500/20 p-2.5 rounded-lg space-y-1">
                      ...
                      <p className="text-[10px] text-slate-500">TTL: {repo.cache_ttl_hours}h cache retention</p>
                    </div>
                  )}
